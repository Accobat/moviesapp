...
<template>
  <div class="movie-info-wrap">
    <header class="movie-info-header">
      ...
      <BIconX class="close-icon" @click="closeModel" />
    </header>
    <div class="movie-info-content">
      <BRow>
        ...
        <BCol sm="8">
          ...
          <div class="mt-3 mb-4">
            <BBadge class="mr-2 variant-bbadge">{{ movie.Year }}</BBadge>
            <BBadge class="mr-2 variant-bbadge">{{ movie.Runtime }}</BBadge>
            <BBadge class="mr-2 variant-bbadge">{{ movie.Genre }}</BBadge>
            <BBadge class="mr-2 variant-bbadge">{{ movie.Language }}</BBadge>
          </div>
